...
<div class="pub-row">
  <div class="col-sm-3 abbr" style="position: relative;padding-right: 15px;padding-left: 15px;">
    {% if link.image %} 
    <img src="{{ link.image }}" class="teaser img-fluid z-depth-1"{% if link.image_fit %} style="object-fit: {{ link.image_fit }}; background-color: #fff;"{% endif %}>
    {% endif %}
  ...
  <div class="col-sm-9" style="position: relative;padding-right: 15px;padding-left: 20px;">
      <div class="title"><a href="{{ link.pdf }}" style="color: rgba(0, 45, 114, 0.92);">{{ link.title }}</a></div>
